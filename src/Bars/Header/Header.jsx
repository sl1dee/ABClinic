            ...
            <div className='container d-flex align-items-center justify-content-between'>
                ...
                <div className='header-additional d-flex align-items-center'>
                    <div className='contacts d-flex align-items-center'>
                        ...
                        <div className='btn btn-trnsp-dark d-none d-lg-flex justify-content-center' onClick={()=>dispatch(toggleMakeRecordModal(true))}>
                            <span>Записаться</span>
                        </div>
                    </div>
                    <div className='sidenavTrigger d-flex flex-column align-items-center justify-content-between d-xxl-none' onClick={()=>toggle(true)}>
                        <div/>
                    </div>
                </div>
            </div>
