...
const Sidebar = () => {
    ...
    return (
        <div className={cl.sidebar}>
            ...
            <div
                className={cn([cl.sidebarContent, {[cl.sidebarContentClosed]: isWasClosed}, 'd-flex', 'flex-column', 'justify-content-md-between', 'h-100'])}>
                <div
                ...
                <div className={cn([cl.menu, 'd-flex', 'flex-column'])}>
                    ...
                    <div className={cn([cl.contacts, 'd-flex', 'flex-column'])}>
                        ...
                        <Button onClick={openModalHandler} colorStyle="outlined"
                                className={cl.btn}> Записаться </Button>
                    </div>
                </div>
            </div>
        </div>
