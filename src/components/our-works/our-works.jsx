				...
				<div className={cn([cl.ourWorksContent, 'd-flex', 'flex-column'])}>
					...
					>
						...
						>
							...
							<div className={cn([cl.textWrap, 'd-flex', 'justify-content-lg-between', 'flex-column', 'flex-md-row'])}>
								<div
									className={cn([
										cl.description,
										'flex-grow-1',
								...
								>
									<div className={cn([cl.descriptionContent, 'd-none', 'd-lg-flex', 'd-xl-none', 'flex-column'])}>
										<div className={cl.descriptionHeader}>
											<p className="mb-0">Жалобы пациента</p>
										</div>
										<div className={cl.descriptionText}>
