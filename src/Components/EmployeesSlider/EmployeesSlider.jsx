        ...
        <section className='employeesSlider'>
            <div className="container d-flex flex-column">
                ...
                <Swiper slidesPerView={'auto'}
                        spaceBetween={20}
                        modules={[Navigation]}
                        navigation={{nextEl: '.employeesSlider .swiper-button-next', prevEl: '.employeesSlider .swiper-button-prev'}}
                        loop={false}>
                    <SwiperSlide className='employeesSlider-slide d-flex flex-column'>
                        ...
                        <div className='info d-flex flex-column justify-content-between'>
                            ...
                            <div className='info-badge'><p className='mb-0'>Взрослый и детский врач</p></div>
                        </div>
                    </SwiperSlide>
