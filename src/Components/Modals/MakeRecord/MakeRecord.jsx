...
export default function MakeRecord(props)  {
    ...
    return(
        <div className={`ask ${isOpen ? 'active justify-content-center align-items-center' : ''}`}>
            <div className='ask-overlay' onClick={()=>{dispatch(toggleMakeRecordModal(false))}} title='Закрыть'/>
            <div className="ask-block d-flex">
                        ...
                        isOk === 1
                            ...
                            ? <>
                                <div className="text d-flex flex-column">
                                    ...
                                    <p className='request2 mb-0'>Мы рады предложить вам нашу помощь в решении любых вопросов и проблем. Заполните форму обратного звонка, и наши специалисты свяжутся с вами.</p>
                                </div>
                                ...
                                <form className="d-flex flex-column" ref={form} onSubmit={(e)=>{submitForm(e)}}>
                                    ...
                                    <div className='d-flex flex-column'>
                                        ...
                                        <p className="text-center">Нажимая на кнопку, вы соглашаетесь с <a href="/policy" target='_blank'>Политикой конфиденциальности</a></p>
                                    </div>
                                </form>
                            </>
                            : <div className="text d-flex flex-column">
                ...
                <div className='ask-block-image d-none d-md-block w-100' style={{backgroundImage: 'url("/media/makeRecord/1.jpg")'}}/>
            </div>
        </div>
    );
}