      ...
      <div className="container d-flex flex-column">
        <div className="about-headerWrap d-flex flex-column flex-lg-row align-items-start">
          ...
          <div className="about-description">
            <p className="mb-0">
              AB Clinic работают профессиональные и опытные врачи. Среди наших услуг взрослая и
              детская стоматология, лечение кариеса, исправление прикуса, установка брекетов и
              элайнеров, имплантация, профессиональная гигиена.
            </p>
          </div>
        </div>
        <Swiper
